...
public interface PhoneNumberController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "No country matches provided phone number",
                    content = @Content) })
    ResponseEntity<Set<String>> getCountriesByPhoneNumber(@RequestParam String phoneNumber) throws CountryNotFoundException, PhoneNumberNotValidException, IOException;
}
